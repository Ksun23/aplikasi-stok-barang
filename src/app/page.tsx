  ...
  return (
    <>
      <div className="w-screen h-screen ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-1 px-[2cm]">
        ...
        <div className="bg-gray-50 py-16 mt-[4cm] px-6 md:px-12 text-gray-800">
          <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="bg-white py-16 px-6 md:px-12 text-gray-800 mt-[2cm]">
          <div className="max-w-6xl mx-auto text-center">
        ...
        <footer className="bg-gray-900 text-white py-12 px-6">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Logo dan Deskripsi */}
            <div>
              <h2 className="text-2xl font-bold mb-4">StokBarang.co.id</h2>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>Email: <a href="mailto:info@stockmanager.com" className="hover:text-[#FAB420] transition">info@stockmanager.com</a></li>
          ...
          <div className="mt-12 border-t border-gray-700 pt-6 text-center text-gray-400">
            © {new Date().getFullYear()} StokBarang.co.id Semua Hak Dilindungi.
          </div>
        </footer>
      </div>
    </>
